...
\begin{tabularx}{\textwidth}{>{\bfseries}p{1.5cm}p{3.4cm}X}
...
Da includere: \texttt{src/App.tsx} come orchestratore, \texttt{src/canvas}, \texttt{src/components}, \texttt{src/inspector}, \texttt{src/toolbar}, \texttt{src/translation}, \texttt{src/logical}, \texttt{src/i18n}, \texttt{src/types}, \texttt{src/utils}.
